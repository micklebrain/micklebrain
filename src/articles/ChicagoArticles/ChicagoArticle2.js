...
class ChicagoArticle2 extends React.Component {
    ...
    getRestaurantDetails() {
        ...
        fetch(
            "https://lostmindsbackend.vercel.app/resturants/chicago", requestOptions)
    ...
    render() {
        ...
        return (<div class="container">
            <h1> Top Restaurants in Chicago </h1>
            <h1> January, 2022 </h1>
            <div>
                {restaurantsList}
            </div>
...
export default ChicagoArticle2