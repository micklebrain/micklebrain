...
class Philadelphia extends React.Component {
    ...
    render() {
        return (<div class='articleContainer'>
            ...
            <div class="column-main">
                <Link to="/NYCPhiladelphiaNeighborhoodRestaurantsArticle" class="articlePreview"> <img class="articleImage" src={philadelphia} alt="Upcoming events" /> </Link> <div> <div class="articleTitle"> Top restaraunt in every Philadelphia neighborhood </div> <div> Jan 27, 2022 </div> </div>
            </div>
        </div>)
    }
}
